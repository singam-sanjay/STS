...
extern "C" {
#endif
int32_t trns(int32_t n1, int32_t *Mp1, int32_t *Mi1, double *Mx1, int32_t *Mip1, double *D2, double *D2, int32_t *setPtr, int32_t *setVal, int32_t ub, int32_t *blk2Col, int32_t blkNo) {
 {
